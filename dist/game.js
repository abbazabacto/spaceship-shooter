...
var starGeometry = new _three2.default.SphereGeometry(0.5, 16, 8);
...
var Stars = exports.Stars = _rx2.default.Observable.range(0, 1000).map(function () {
  var star = new _three2.default.Mesh(starGeometry, starMaterial);
...
//compose
document.body.appendChild(_tools.renderer.domElement);
...
DeviceOrientationControls.flatMapLatest(function () {
  ...
  (0, _utils.fullscreen)(_renderer.renderer.domElement);
});
...
},{"../../lib/DeviceOrientationControls":1,"../../lib/OrbitControls":4,"../utils":26,"./camera":22,"./renderer":24,"rx":10}],24:[function(require,module,exports){
(function (global){
'use strict';
...
var renderer = exports.renderer = new _three2.default.WebGLRenderer({ antialias: true });
...
},{"../../lib/StereoEffect":5,"rx":10}],25:[function(require,module,exports){
(function (global){
'use strict';
...
exports.AspectRatio = exports.getAspectRatio = undefined;
...
var getAspectRatio = exports.getAspectRatio = createGetAspectRatio(_renderer.renderer.domElement);

var AspectRatio = exports.AspectRatio = _misc.DomReady.flatMap(function () {
  return _rx2.default.Observable.fromEvent(window, 'resize').map(getAspectRatio).startWith(getAspectRatio()).shareReplay(1);
});
...
},{"../../lib/FontUtils":2,"../../lib/GeometryUtils":3,"../../lib/TextGeometry":6,"../../res/fonts/helvetiker_bold.typeface":11,"../../res/fonts/helvetiker_regular.typeface":12}]},{},[19])
