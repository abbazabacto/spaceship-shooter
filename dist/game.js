...
_actors.spaceshipMesh$.subscribe(function (spaceShipMesh) {
  var mesh = spaceShipMesh.clone();
  mesh.position.y = -10;
  mesh.rotation.y = (0, _utils.getRad)(-180);
  _tools.scene.add(mesh);
});
...
},{"./utils/misc":38,"./utils/screen":40,"./utils/text":41,"./utils/video":42,"./utils/webrtc":43}],38:[function(require,module,exports){
'use strict';
