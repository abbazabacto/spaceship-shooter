...
},{"rx":16}],15:[function(require,module,exports){
var Rx = require('rx');
require('./dist/rx.dom');
module.exports = Rx;
},{"./dist/rx.dom":14,"rx":16}],16:[function(require,module,exports){
...
var enemyGeometry = new _three2.default.BoxGeometry(10, 10, 10);
...
var enemies$ = exports.enemies$ = _rx2.default.Observable.merge(addEnemy$.map(function (index) {
  ...
  enemy.position.x = (0, _utils.randomFromRange)(-250, 250);
  enemy.position.y = (0, _utils.randomFromRange)(-250, 250);
  enemy.position.z = -500;
  enemy.lookAt(new _three2.default.Vector3(_tools.camera.position.x, _tools.camera.position.y + 10, _tools.camera.position.z));
...
var shots$ = exports.shots$ = _rx2.default.Observable.merge(addShot$.map(function (index) {
  ...
  shot.position.y = _tools.camera.position.y - 10;
...
exports.spaceshipMesh$ = undefined;
...
},{"./actors":19,"./tools":27,"./utils":34,"rx":16,"rx-dom":15}],27:[function(require,module,exports){
'use strict';
...
},{"./tools/animationFrame":28,"./tools/camera":29,"./tools/controls":30,"./tools/renderer":31,"./tools/scene":32,"./tools/stats":33}],28:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils":34,"rx":16,"rx-dom":15}],29:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils":34,"./renderer":31}],30:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/controls/DeviceOrientationControls":1,"../../lib/controls/OrbitControls":2,"../../lib/controls/VRControls":3,"./camera":29,"./renderer":31,"rx":16}],31:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/stats/stats.min":8,"../../lib/stats/threex.rendererstats":9,"rx":16}],34:[function(require,module,exports){
'use strict';
...
},{"rx":16,"rx-dom":15}],36:[function(require,module,exports){
'use strict';
...
},{"../tools/renderer":31,"./misc":35,"rx":16,"rx-dom":15}],37:[function(require,module,exports){
(function (global){
'use strict';
