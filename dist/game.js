...
var _loop = function _loop(_key7) {
  ...
  Object.defineProperty(exports, _key7, {
    enumerable: true,
    get: function get() {
      return _enemies[_key7];
    }
  });
};

for (var _key7 in _enemies) {
...
var _loop4 = function _loop4(_key10) {
  ...
  Object.defineProperty(exports, _key10, {
    enumerable: true,
    get: function get() {
      return _spaceship[_key10];
    }
  });
};

for (var _key10 in _spaceship) {
...
var _loop6 = function _loop6(_key12) {
  ...
  Object.defineProperty(exports, _key12, {
    enumerable: true,
    get: function get() {
      return _planets[_key12];
    }
  });
};

for (var _key12 in _planets) {
...
},{"../tools":31,"../utils":40,"rx":20}],25:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../tools":31,"../utils":40,"./score":27,"rx":20}],26:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/planets/threex.atmospherematerial":10,"../../lib/planets/threex.planets":11,"../tools":31,"../utils":40,"rx":20}],27:[function(require,module,exports){
'use strict';
...
},{"../tools":31,"../utils":40,"rx":20}],28:[function(require,module,exports){
(function (global){
'use strict';
...
var addShot$ = _rx2.default.Observable.merge(_tools.triggerdown$.flatMap(function () {
  return interval$.takeUntil(_tools.triggerup$);
}), _rx2.default.DOM.touchstart(_tools.renderer.domElement).flatMap(function () {
...
},{"../utils/misc":41,"../utils/models":42,"rx":20}],30:[function(require,module,exports){
(function (global){
'use strict';
...
_actors.spaceshipObject$.subscribe(function (spaceshipObject) {
  ...
  (0, _tools.addRenderer)(function () {
    ...
    object.position.x = _tools.camera.position.x;
    object.position.y = _tools.camera.position.y + -4 * scale;
    object.position.z = _tools.camera.position.z + -1 * scale;
  });
...
},{"./actors":23,"./tools":31,"./tools/gameLoop":35,"./utils":40,"rx":20,"rx-dom":19}],31:[function(require,module,exports){
'use strict';
...
var _loop = function _loop(_key8) {
  ...
  Object.defineProperty(exports, _key8, {
    enumerable: true,
    get: function get() {
      return _animationFrame[_key8];
    }
  });
};

for (var _key8 in _animationFrame) {
...
var _loop2 = function _loop2(_key9) {
  ...
  Object.defineProperty(exports, _key9, {
    enumerable: true,
    get: function get() {
      return _camera[_key9];
    }
  });
};

for (var _key9 in _camera) {
...
var _loop3 = function _loop3(_key10) {
  ...
  Object.defineProperty(exports, _key10, {
    enumerable: true,
    get: function get() {
      return _controls[_key10];
    }
  });
};

for (var _key10 in _controls) {
  var _ret3 = _loop3(_key10);

  if (_ret3 === 'continue') continue;
}

var _gamepad = require('./tools/gamepad');
...
var _loop4 = function _loop4(_key11) {
  ...
  Object.defineProperty(exports, _key11, {
    enumerable: true,
    get: function get() {
      return _gamepad[_key11];
    }
  });
};

for (var _key11 in _gamepad) {
...
var _loop5 = function _loop5(_key12) {
  ...
  Object.defineProperty(exports, _key12, {
    enumerable: true,
    get: function get() {
      return _renderer[_key12];
    }
  });
};

for (var _key12 in _renderer) {
...
var _loop6 = function _loop6(_key13) {
  ...
  Object.defineProperty(exports, _key13, {
    enumerable: true,
    get: function get() {
      return _scene[_key13];
    }
  });
};

for (var _key13 in _scene) {
...
var _loop7 = function _loop7(_key14) {
  ...
  Object.defineProperty(exports, _key14, {
    enumerable: true,
    get: function get() {
      return _stats[_key14];
    }
  });
};

for (var _key14 in _stats) {
  var _ret7 = _loop7(_key14);

  if (_ret7 === 'continue') continue;
}

},{"./tools/animationFrame":32,"./tools/camera":33,"./tools/controls":34,"./tools/gamepad":36,"./tools/renderer":37,"./tools/scene":38,"./tools/stats":39}],32:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils":40,"./renderer":37,"rx":20,"rx-dom":19}],33:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils":40,"./renderer":37}],34:[function(require,module,exports){
(function (global){
'use strict';
...
exports.controls$ = exports.vrControls = undefined;
...
var vrControls = exports.vrControls = new _three2.default.VRControls(_camera.camera, function () {
...
},{"../../lib/controls/DeviceOrientationControls":1,"../../lib/controls/OrbitControls":2,"../../lib/controls/VRControls":3,"./camera":33,"./renderer":37,"./scene":38,"rx":20}],35:[function(require,module,exports){
'use strict';
...
exports.triggerup$ = exports.triggerdown$ = undefined;
...
controller1.standingMatrix = _controls.vrControls.getStandingMatrix();
controller1.userData.points = [new _three2.default.Vector3(), new _three2.default.Vector3()];
controller1.userData.matrices = [new _three2.default.Matrix4(), new _three2.default.Matrix4()];
_scene.scene.add(controller1);

var controller2 = new _three2.default.ViveController(1);
controller2.standingMatrix = _controls.vrControls.getStandingMatrix();
controller2.userData.points = [new _three2.default.Vector3(), new _three2.default.Vector3()];
controller2.userData.matrices = [new _three2.default.Matrix4(), new _three2.default.Matrix4()];
...
var controllerUpdate = function controllerUpdate() {
  controller1.update();
  controller2.update();

  if (controller1.visible === false || controller2.visible === false) {
    console.log('No Vive controller found');
    (0, _renderer.removeRenderer)(controllerUpdate);
  }
};

(0, _renderer.addRenderer)(controllerUpdate);

var triggerdown$ = exports.triggerdown$ = _rx2.default.Observable.fromEvent(controller1, 'triggerdown');
var triggerup$ = exports.triggerup$ = _rx2.default.Observable.fromEvent(controller1, 'triggerup');

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"../../lib/gamepad/ViveController":6,"./controls":34,"./renderer":37,"./scene":38,"rx":20}],37:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/effects/StereoEffect":4,"../../lib/effects/VREffect":5,"../utils/screen":43,"../utils/webrtc":46,"./scene":38,"rx":20}],38:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/stats/stats.min":12,"../../lib/stats/threex.rendererstats":13,"rx":20}],40:[function(require,module,exports){
'use strict';
...
var _loop2 = function _loop2(_key8) {
  ...
  Object.defineProperty(exports, _key8, {
    enumerable: true,
    get: function get() {
      return _models[_key8];
    }
  });
};

for (var _key8 in _models) {
  var _ret2 = _loop2(_key8);
...
var _loop4 = function _loop4(_key10) {
  ...
  Object.defineProperty(exports, _key10, {
    enumerable: true,
    get: function get() {
      return _screen[_key10];
    }
  });
};

for (var _key10 in _screen) {
  var _ret4 = _loop4(_key10);
...
var _loop6 = function _loop6(_key12) {
  ...
  Object.defineProperty(exports, _key12, {
    enumerable: true,
    get: function get() {
      return _webrtc[_key12];
    }
  });
};

for (var _key12 in _webrtc) {
  var _ret6 = _loop6(_key12);

  if (_ret6 === 'continue') continue;
}

},{"./utils/misc":41,"./utils/models":42,"./utils/screen":43,"./utils/text":44,"./utils/video":45,"./utils/webrtc":46}],41:[function(require,module,exports){
'use strict';
...
},{"rx":20,"rx-dom":19}],42:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/loaders/DDSLoader":7,"../../lib/loaders/MTLLoader":8,"../../lib/loaders/OBJLoader":9,"rx":20}],43:[function(require,module,exports){
'use strict';
...
},{"../tools/renderer":37,"./misc":41,"rx":20,"rx-dom":19}],44:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../lib/text/FontUtils":14,"../../lib/text/GeometryUtils":15,"../../lib/text/TextGeometry":16,"../../res/fonts/helvetiker_bold.typeface":21,"../../res/fonts/helvetiker_regular.typeface":22}],45:[function(require,module,exports){
'use strict';
...
},{"rx":20}],46:[function(require,module,exports){
'use strict';
